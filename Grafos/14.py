...
# sala de estar, terraza y patio; 
# b. cargar al menos tres aristas a cada vértice, y a dos de estas cárguele cinco, el peso de la arista es de la distancia entre los ambientes, 
# se debe cargar en metros; 
...
# d. determinar cuál es el camino más corto desde la habitación 1 hasta la sala de estar para deteminar cuántos metros de cable de red se 
# necesitan para conectar el router con el Smart TV.  
